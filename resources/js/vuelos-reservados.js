...
export default class Reservas {
  ...
  static async init(usuarioId) {
    ...
    let nestedData = responseVuelos.data.filter(t =>{return t.usuario.identificacion == usuarioId.identificacion})
...
const data = this.#getFormData(cell,this.#IdUsuario.identificacion,document.querySelector('#fecha-hora').value)/////////////////////////////
...
const data = this.#getFormData(row,this.#IdUsuario.identificacion, data2.reserva.fechaHora)[0]
console.log(c, data)
...
content: `
  ...
  Silla: ${cell.getRow().getData().silla.posicion} <br>
`,
buttons: [
    {
        id: "add-flights",
